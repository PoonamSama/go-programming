...
func (x rect) area() int { //receiver is of type t (not ptr)
...
func main() {
	...
	fmt.Println(r1.area())
	fmt.Println(r2.area())
	xy := printing(&r1) //value is *T, receiver is T,it works
	fmt.Println("area of r1 throughfunc printing is:", xy)

	fmt.Println("area of s2 throughfunc printing is:", printing(&s2))
	fmt.Println("area of r2 throughfunc printing is:", printing(r2)) // //value is T ,receiver is T,it works
}
